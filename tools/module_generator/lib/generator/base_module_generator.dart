  ...
  if (inputModuleName != null && inputModuleDir != null) {
    ...
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/bloc/bloc.txt',
        className: className,
    ...
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/bloc/state.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/bloc/event.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    ...
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/interactor/interactor.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate:
            'common_module/interactor/interactor.impl.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    ...
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/repository/repository.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate:
            'common_module/repository/repository.impl.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    ...
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/views/screen.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/views/action.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    ...
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/route.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
    ...
    await FilesHelper.writeFile(
      ...
      content: await openTemplateAndReplaceContent(
        relativeFilePathFromTemplate: 'common_module/module.txt',
        className: className,
        moduleName: moduleName,
      ),
    );
