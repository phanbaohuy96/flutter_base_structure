...
class DatePickerModel extends CommonPickerModel {
  ...
  int _maxDayOfCurrentMonth() {
    final dayCount = calcDateCount(currentTime.year, currentTime.month);
  ...
  void setLeftIndex(int index) {
    ...
    var minMonth = _minMonthOfCurrentYear();
    DateTime newTime;
    //change date time
  ...
  void setMiddleIndex(int index) {
    ...
    DateTime newTime;
    //change date time
    final dayCount = calcDateCount(currentTime.year, destMonth);
    newTime = currentTime.isUtc
        ? DateTime.utc(
            currentTime.year,
            destMonth,
...
class Time12hPickerModel extends CommonPickerModel {
  ...
  @override
  DateTime finalTime() {
    final hour = _currentLeftIndex + 12 * _currentRightIndex;
    return currentTime.isUtc
        ? DateTime.utc(
            currentTime.year,
            currentTime.month,
...
class DateTimePickerModel extends CommonPickerModel {
  ...
  void setMiddleIndex(int index) {
    super.setMiddleIndex(index);
    final time = currentTime.add(Duration(days: _currentLeftIndex));
