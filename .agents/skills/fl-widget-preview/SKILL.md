...
- If E2E/spec verification is requested, use the `fl-testing` skill and `flutter_skill` guidance separately.
- If you cannot run the previewer, report the exact blocker.

## Related

- [`fl-theme-usage`](../fl-theme-usage/SKILL.md)
- [`fl-testing`](../fl-testing/SKILL.md)
- [`fl-behavioral-guardrails`](../fl-behavioral-guardrails/SKILL.md)
