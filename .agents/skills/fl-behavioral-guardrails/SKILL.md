...
- New feature requests should use `fl-module-scaffold`, `fl-bloc-pattern`, and `fl-route-config` rather than ad-hoc Flutter structure.
...
| Navigation | `IRoute`, `CustomRouter`, coordinators | fl-route-config checklist |
