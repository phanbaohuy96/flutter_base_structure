...
const riveAssetsStatesRes =
    '''class ${classNameKey}States {
  ${classNameKey}States();$contentKey
}
''';

const riveAssetsInputsRes =
    '''class ${classNameKey}Inputs {
  ${classNameKey}Inputs();$contentKey
}
''';

const riveAssetsMachinesRes =
    '''class ${classNameKey}Machines {
